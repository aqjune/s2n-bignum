...
let BIGNUM_EMONTREDC_8N_VEC_CORRECT = time prove
 (`!k z m w a n pc.
...
let BIGNUM_EMONTREDC_8N_VEC_SUBROUTINE_CORRECT = time prove
 (`!k z m w a n pc stackpointer returnaddress.
  ...
  ARM_ADD_RETURN_STACK_TAC
    BIGNUM_EMONTREDC_8N_NEON_EXEC BIGNUM_EMONTREDC_8N_VEC_CORRECT
