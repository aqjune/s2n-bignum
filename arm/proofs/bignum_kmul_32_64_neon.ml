...
let LOCAL_MUL_8_16_VEC_CORRECT = prove
...
let LOCAL_KMUL_16_32_VEC_CORRECT = prove
 (`!z x y a b t pc.
  ...
  LOCAL_MUL_8_16_VEC_TAC 49 THEN
  ...
  LOCAL_MUL_8_16_VEC_TAC 129 THEN
...
let LOCAL_KMUL_16_32_VEC_SUBR_CORRECT = prove
 (`!z x y a b t pc stackpointer returnaddress.
  ...
  ARM_ADD_RETURN_STACK_TAC
   BIGNUM_KMUL_32_64_NEON_EXEC LOCAL_KMUL_16_32_VEC_CORRECT
    `[X19;X20;X21;X22;X23;X30]` 48);;

let LOCAL_KMUL_16_32_VEC_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_kmul_32_64_neon_mc,BIGNUM_KMUL_32_64_NEON_EXEC,
     0x0,bignum_kmul_32_64_neon_mc,LOCAL_KMUL_16_32_VEC_SUBR_CORRECT)
    [`read X0 s`; `read X1 s`; `read X2 s`;
...
(* -- Mar 4. 2:13 pm (seoul time): okay until here -- *)

let BIGNUM_KMUL_32_64_VEC_SUBROUTINE_CORRECT = prove(
  `!z x y a b t pc stackpointer returnaddress.
        aligned 16 stackpointer /\
        PAIRWISE nonoverlapping
 ...
 (*** Split L into L_top and L_bot and form H' = H + L_top ***)
  ...
  LOCAL_KMUL_16_32_VEC_TAC 239 THEN
