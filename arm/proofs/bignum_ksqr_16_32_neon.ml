...
let BIGNUM_KSQR_16_32_VEC_LEMMA = prove
...
let BIGNUM_KSQR_16_32_VEC_LEMMA_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_ksqr_16_32_neon_mc,BIGNUM_KSQR_16_32_NEON_EXEC,
     0x0,bignum_ksqr_16_32_neon_mc,BIGNUM_KSQR_16_32_VEC_LEMMA)
    [`read X0 s`; `read X1 s`;
...
let BIGNUM_KSQR_16_32_VEC_CORRECT = prove
 (`!z x a t pc.
  ...
  BIGNUM_KSQR_16_32_VEC_LEMMA_TAC 5 THEN
  ...
  BIGNUM_KSQR_16_32_VEC_LEMMA_TAC 47 THEN
  ...
  BIGNUM_KSQR_16_32_VEC_LEMMA_TAC 87 THEN
...
let BIGNUM_KSQR_16_32_VEC_SUBROUTINE_CORRECT = prove
 (`!z x a t pc stackpointer returnaddress.
  ...
  ARM_ADD_RETURN_STACK_TAC
   BIGNUM_KSQR_16_32_NEON_EXEC BIGNUM_KSQR_16_32_VEC_CORRECT
