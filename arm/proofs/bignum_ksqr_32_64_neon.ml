...
let BIGNUM_KSQR_32_64_VEC_SUBLEMMA = prove
 (`!z x a pc returnaddress.
  ...
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [55] (55--55) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (56--56) THEN (* mov x11, v5.d[0] *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [57] (57--57) THEN (* mul x15, x2, x3 *)
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [58] (58--58) THEN (* mov x13, v3.d[1] *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (59--59) THEN (* umulh x16, x2, x3 *)
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (60--60) THEN (* mov x14, v5.d[1] *)
  ...
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [82] (82--82) THEN (* mov x12, v3.d[0] = mul x12, x4, x4 *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [83] (83--83) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (84--84) THEN (* mov x11, v5.d[0] = umulh x11, x4, x4 *)
  simplify_128bit_words THEN (* simplify 84 *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (85--85) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [86] (86--86) THEN (* mov x13, v3.d[1] = mul x13, x5, x5 *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [87] (87--87) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (88--88) THEN (* mov x14, v5.d[1] = umulh x14, x5, x5 *)
  simplify_128bit_words THEN (* simplify 88 *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (89--89) THEN

  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [91;93;94;95;96;97;98;99;101;102] (90--103) THEN
  ...
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [152] (152--152) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (153--153) THEN
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [154] (154--154) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [155] (155--155) THEN

  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [156] (156--156) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (157--157) THEN
  simplify_128bit_words THEN (* simplify 157 *)

  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [158;160;162;164;166;168;172;174;176;178] (158--178) THEN

  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [179] (179--179) THEN
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [180] (180--180) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (181--181) THEN
  simplify_128bit_words THEN (* simplify 181 *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (182--182) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [183] (183--183) THEN
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [184] (184--184) THEN
  ARM_NEON_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [] (185--185) THEN
  simplify_128bit_words THEN (* simplify 185 *)
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC [187;188;189;190;191;192;193;194;196;197] (186--198) THEN
  ...
  ARM_ACCSTEPS_TAC BIGNUM_KSQR_32_64_NEON_EXEC (318--350) (318--351) THEN
...
let BIGNUM_KSQR_32_64_VEC_SUBLEMMA_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_NEON_EXEC,
     0x0,bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_VEC_SUBLEMMA)
    [`read X0 s`; `read X1 s`;
...
let BIGNUM_KSQR_32_64_VEC_LEMMA = prove
 (`!z x a t pc.
  ...
  BIGNUM_KSQR_32_64_VEC_SUBLEMMA_TAC 5 THEN
  ...
  BIGNUM_KSQR_32_64_VEC_SUBLEMMA_TAC 47 THEN
  ...
  BIGNUM_KSQR_32_64_VEC_SUBLEMMA_TAC 87 THEN
...
let BIGNUM_KSQR_32_64_VEC_SUBROUTINE_LEMMA = prove
 (`!z x a t pc stackpointer returnaddress.
  ...
  ARM_ADD_RETURN_STACK_TAC
   BIGNUM_KSQR_32_64_NEON_EXEC BIGNUM_KSQR_32_64_VEC_LEMMA
    `[X19;X20;X21;X22;X23;X24;X25;X30]` 64);;

let BIGNUM_KSQR_32_64_VEC_LEMMA_TAC =
  ARM_SUBROUTINE_SIM_TAC
    (bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_NEON_EXEC,
     0x0,bignum_ksqr_32_64_neon_mc,BIGNUM_KSQR_32_64_VEC_SUBROUTINE_LEMMA)
    [`read X0 s`; `read X1 s`;
...
let BIGNUM_KSQR_32_64_VEC_SUBROUTINE_CORRECT = prove
 (`!z x t a pc stackpointer returnaddress.
  ...
  BIGNUM_KSQR_32_64_VEC_LEMMA_TAC 161 THEN
